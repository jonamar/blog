...
This repository contains my personal blog built with Jekyll using the [no-style-please](https://github.com/riggraz/no-style-please) theme - a (nearly) no-CSS, fast, minimalist Jekyll theme.
...
3. Configure GitHub Pages in the repository settings to use the `main` branch
